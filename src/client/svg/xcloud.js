...
module.exports = function(width, height, fillColor) {
  return [
    m(
      "svg[height='32'][id='svg2'][inkscape:version='0.91 r13725'][sodipodi:docname='xcloud.svg'][version='1.1'][viewBox='0 0 40 32'][width='40'][x='0px'][xmlns='http://www.w3.org/2000/svg'][xmlns:cc='http://creativecommons.org/ns#'][xmlns:dc='http://purl.org/dc/elements/1.1/'][xmlns:inkscape='http://www.inkscape.org/namespaces/inkscape'][xmlns:rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'][xmlns:sodipodi='http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd'][xmlns:svg='http://www.w3.org/2000/svg'][y='0px']",
      [
        m("metadata[id='metadata12']", [
          m("rdf:rdf", [
            m("cc:work[rdf:about='']", [
              m("dc:format", "image/svg+xml"),
              m(
        ...
        m(
          "g[id='g4'][transform='matrix(0.44,0,0,0.44,-2.5613949,-423.68403)']",
          {
            style: {
              fill: "#ff0000"
            }
