...
module.exports.toDate = function (dateString) {
    ...
    if (matches === null) {
        throw new TypeError("'" + dateString + "'" + ' does not look like a valid date.')
    }

    if (matches[2] === '00') { // month must be 1 or greater
        throw new TypeError('Invalid date string; month must not be 00. Passed string was: ' + dateString)
    }
